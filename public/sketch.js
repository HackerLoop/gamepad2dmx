...
function setup() {
  var canvas = createCanvas(360, 270);
...
function drawTarget(detection) {
  ...
  stroke(0, 255, 0);
  strokeWeight(4);
  circle(centerX, centerY, boxWidth/5);

  sendTarget(screenCenterX - centerX, screenCenterY - centerY)
}
